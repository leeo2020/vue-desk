    ...
    <div class="lx-table">
      ...
      >
        ...
        <el-table-column
          ...
          label="序号"
        ></el-table-column>
        <el-table-column type="expand" width="60" label="展开行">
          <template slot-scope="props">
            <el-table-item label="商品名称">
              <span>{{ props.row.name }}</span>
            </el-table-item>
            <el-table-item label="商品种类">
              <span>{{ props.row.cate }}</span>
            </el-table-item>
          </template>
        </el-table-column>
        ...
        <el-table-column label="分类">
          <template v-slot="scope"
            ><span>{{ cateMapper(scope.row.cate) }}</span></template
          >
        </el-table-column>
...
export default {
  ...
  computed: {
    ...mapState("good", ["goodQueryList", "cateList"]),
  },
  created() {
    this.initCate();
  },
  ...
  methods: {
    ...mapMutations("good", ["mutateGoodQueryList", "mutateCateList"]),
    ...
    batchSelect() {
      console.log(this.$refs["good-table"].selection);
    },
    cateMapper(val) {
      const cateMap = [
        { _id: "5fba0d9da20aa5233f99f44d", cate: "coat", cate_zh: "衣服" },

        { _id: "5fba0dcba20aa5233f99f44e", cate: "computer", cate_zh: "电脑" },

        { _id: "5fba0de7a20aa5233f99f44f", cate: "beauty", cate_zh: "美妆" },
      ];
      return cateMap.find(({ cate }) => cate === val)["cate_zh"];
    },
  },
};
</script>
